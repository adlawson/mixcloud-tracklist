/*
 * Mixcloud Tracklist Firefox extension
 *
...
function onDocumentReady(fn) {
    var containers = Array.prototype.slice.call(document.querySelectorAll(constants.QUERY_MAIN));
    fn();
    containers.forEach(function (element) {
        onDocumentChange(element, fn);
    });
}
...
function displayPlayerBarTracklist() {
    onDocumentReady(function () {
        try {
